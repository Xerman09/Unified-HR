...
export const APP_GROUPS: AppGroup[] = [
  {
    ...
    items: [
      ...
      { id: "men2-payroll", label: "Payroll System", url: "http://192.168.0.143:9011/auth/login", fallbackUrl: "http://goatedcodoer:9011/auth/login", isPayroll: true },
    ],
  },
  {
    group: "Vertex",
    items: [
      ...
      { id: "vertex-payroll", label: "Payroll System", url: "http://192.168.0.143:9012/auth/login", fallbackUrl: "http://goatedcodoer:9012/auth/login", isPayroll: true },
    ],
  },
  {
    group: "HANVIN",
    items: [
      ...
      { id: "hanvin-payroll", label: "Payroll System", url: "http://192.168.0.143:9013/auth/login", fallbackUrl: "http://goatedcodoer:9013/auth/login", isPayroll: true },
    ],
  },
  {
