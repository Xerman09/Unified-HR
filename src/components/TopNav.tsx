...
import { ExternalLink, MenuIcon } from "@/components/icons";
  ...
  return (
    <header className="h-20 shrink-0 glass border-b border-zinc-200/50 px-8 flex items-center justify-between sticky top-0 z-50">
      <div className="flex items-center gap-6 min-w-0">
        <button
          onClick={toggle}
          className="p-2.5 rounded-xl hover:bg-zinc-100 text-zinc-500 hover:text-zinc-900 transition-colors border border-transparent hover:border-zinc-200 shadow-sm hover:shadow-md"
